...
def save_songs_to_abc(song, filename="tmp"):
...
def play_generated_song(generated_text):
    ...
    if len(songs) == 0:
        print("No valid songs found in generated text. Try training the model longer or increasing the amount of "
              "generated music to ensure complete songs are generated!")

    for song in songs:
        basename = save_songs_to_abc(song)
